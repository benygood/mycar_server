...
@Component
public class AudioFromNettyTcpServer {
    private static final Logger logger = LogManager.getLogger(AudioFromNettyTcpServer.class);
    ...
    public  void start() throws InterruptedException {
        ...
        serverBootstrap.childHandler(new AudioFromChannelInitializer());
        ...
        if (channelFuture.isSuccess()) {
            logger.info("Audio-From-TCP-Server success---------------");
        }
    ...
    public synchronized void stopServer() {
        ...
        logger.info("Audio-From-TCP-Server 服务已经停止...");
    }

    private String getName() {
        return "Audio-From-TCP-Server";
    }
