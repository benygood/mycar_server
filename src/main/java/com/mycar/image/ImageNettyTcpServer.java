...
@Component
public class ImageNettyTcpServer {
    private static final Logger logger = LogManager.getLogger(ImageNettyTcpServer.class);
    ...
    public void start() throws InterruptedException {
        ...
        if (channelFuture.isSuccess()) {
            logger.info("Image-TCP-Server success---------------");
        }
    ...
    public synchronized void stopServer() {
        ...
        logger.info("Image-TCP-Server服务已经停止...");
    }

    private String getName() {
        return "Image-TCP-Server";
    }
}
